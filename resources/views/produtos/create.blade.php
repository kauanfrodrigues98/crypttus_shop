            ...
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="preco_compra" id="preco_compra" class="form-control form-control-sm" required>
                    </div>
                    <div class="col-md-3">
                        <label for="preco_venda">Preço Venda</label>
                        <input type="text" name="preco_venda" id="preco_venda" class="form-control form-control-sm" required>
                    </div>
                </div>
            </div>
        </div>
