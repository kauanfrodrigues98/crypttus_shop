...
@section('tab-title', 'Novo Cliente')
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="data_nascimento" id="data_nascimento"
                               class="form-control form-control-sm" required value="{{ $cliente->data_nascimento }}">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="uf" id="uf" class="custom-select custom-select-sm">
                            ...
                            @foreach($ufs as $key => $uf)
                                <option
                                    value="{{ $key }}" {{ $cliente->uf === $key ? 'selected' : '' }}>{{ $uf }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <textarea name="complemento" id="complemento" cols="30" rows="1"
                                  class="form-control form-control-sm">{{ $cliente->complemento }}</textarea>
                    </div>
                </div>
            </div>
        </div>
